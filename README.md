...
- **[MemoryLane](https://github.com/deusXmachina-dev/memorylane)** - Desktop app that captures screen activity, stores text summaries locally, and exposes your history to AI assistants via MCP for contextual recall.
